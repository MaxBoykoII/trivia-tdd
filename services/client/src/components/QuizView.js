    ...
    return (
      <div className="quiz-play-holder">
        ...
        <div className="category-holder">
          <div className="play-category" onClick={this.handleSelectCategory}>
            ALL
          </div>
  ...
  renderFinalScore() {
    return (
      <div className="quiz-play-holder">
        ...
        <div className="play-again button" onClick={this.handleRestartGame}>
          {" "}
          Play Again?{" "}
        </div>
      </div>
    ...
    return (
      <div className="quiz-play-holder">
        ...
        <div
          ...
          onClick={this.handleGetNextQuestion}
        >
          {" "}
          Next Question{" "}
        </div>
